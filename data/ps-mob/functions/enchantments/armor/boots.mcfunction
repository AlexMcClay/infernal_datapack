...
execute if score @s enchantVal matches 72..81 run function ps-mob:enchantments/armor/all/thorns with storage alex:enchant temp
execute if score @s enchantVal matches 82..92 run function ps-mob:enchantments/general/unbreaking with storage alex:enchant temp
