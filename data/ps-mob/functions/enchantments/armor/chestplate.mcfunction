...
execute if score @s enchantVal matches 48..63 run function ps-mob:enchantments/general/unbreaking with storage alex:enchant temp
execute if score @s enchantVal matches 64..74 run function ps-mob:enchantments/armor/all/projectile_protection with storage alex:enchant temp
execute if score @s enchantVal matches 75..86 run function ps-mob:enchantments/armor/all/protection with storage alex:enchant temp
