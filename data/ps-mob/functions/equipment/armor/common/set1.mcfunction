...
function ps-mob:equipment/armor/chainmail/boots with storage alex:enchant
...
function ps-mob:equipment/armor/chainmail/leggings with storage alex:enchant
...
function ps-mob:equipment/armor/chainmail/chestplate with storage alex:enchant