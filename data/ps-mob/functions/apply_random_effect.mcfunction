...
execute if score @s random_effect matches 41..60 run tag @s add ps-mob.aoeslow5
...
execute if score @s random_effect matches 90..95 run tag @s add ps-mob.aoelightning5s
