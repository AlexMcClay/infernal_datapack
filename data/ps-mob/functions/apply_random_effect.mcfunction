...
execute if score @s random_effect matches 21..30 run tag @s add ps-mob.tp20
execute if score @s random_effect matches 31..40 run tag @s add ps-mob.aoefire5
...
execute if score @s random_effect matches 61..70 run tag @s add ps-mob.aoelev5
execute if score @s random_effect matches 71..80 run tag @s add ps-mob.explosive20s
execute if score @s random_effect matches 81..89 run effect give @s minecraft:regeneration infinite 0
...
tag @s add ps-mob.explosive20s
# tag @s add ps-mob.snow5
